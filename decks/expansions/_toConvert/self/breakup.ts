...
export const level1 = [ // 47 / 50 cards
    ...
    "Picture you're talking to your ex. Finish the sentence: You hurt me, but thank you for _________.",
    ...
    "Who in your life has been treating you right lately? Let them know before moving on to the next card. (Exes not included.)",
    ...
    "Significant other aside, when you visualize coming home to a life you love, what does that look like? Get specific.",
    ...
    "Imagine you're talking to your ex. Finish the sentence: I'm sorry for _________.",
    "What's your ex's name and one thing about them?",
    "Did you like your ex as a person? Or were you just in love? Explain.",
    ...
    "Wild Card Write down 3 things you love about yourself that aren't physical.",
    "Wild Card Write a note to your future self. Fold and place somewhere safe. Set a reminder to open 3 months from today.",
    "Wild Card Write a stand up routine about your last relationship. 1 minute. Read out loud.",
    "Wild Card Write down 3 things you love about yourself physically. Permission to brag.",
    "Wild Card Set a time this week to do something you love and limit any distractions.",
    "Wild Card Write down 3 things you wouldn't change about this current moment.",
    "Wild Card Draw how your heart feels today.",
    "Wild Card Write down 3 things about your last relationship that you will no longer accept moving forward. Get specific.",
